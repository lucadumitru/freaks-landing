(() => {
    ...
    (() => {
        ...
        function updateCountdown(targetClass, eventDate, expiredText, textClass) {
            ...
            countdownElements.forEach((function(countdownElement) {
                ...
                if (timeRemaining <= 0) {
                    ...
                    const daysLeft = Math.ceil(timeRemaining / (1e3 * 60 * 60 * 24));
                    countdownElement.textContent = daysLeft;
                }
            }));
        }
        updateCountdown(".ticker-top__days-left", new Date("2023-10-05"), "THE FREAKNESS IS HERE!", ".ticker-top__text");
        3;
        setInterval((function() {
            updateCountdown(".ticker-top__days-left", new Date("2023-10-05"), "THE FREAKNESS IS HERE!", ".ticker-top__text");
        }), 24 * 60 * 60 * 1e3);
        function closeMenuOnLinkClick(link) {
        ...
        closeMenuOnLinkClick(".menu__link");
        window["FLS"] = true;
        isWebp();
        menuInit();
        spollers();
